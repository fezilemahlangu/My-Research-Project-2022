...
def save_results(fieldnames,total_time,call_back_time,test_acc,test_loss):
    ...
    with open('/home-mscluster/fmahlangu/2089676/atari_riverraid_data/results.csv', 'a', encoding='UTF8') as f:
...
def save_model(fieldnames,first_layer,second_layer,third_layer):
    ...
    with open('/home-mscluster/fmahlangu/2089676/atari_riverraid_data/models.csv', 'a', encoding='UTF8') as f:
        writer = csv.DictWriter(f, fieldnames=fieldnames)
        writer.writerows(rows)
...
def get_data(trial):
    ...
    game_folder= str("/home-mscluster/fmahlangu/2089676/atari_riverraid_data/")
...
def main():
    ...
    with open('/home-mscluster/fmahlangu/2089676/atari_riverraid_data/results.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.DictWriter(f, fieldnames=fieldnames_results)
        writer.writeheader()

    #prepare csv for results 
    fieldnames_m = ['first_layer','second_layer','third_layer'] 
    with open('/home-mscluster/fmahlangu/2089676/atari_riverraid_data/models.csv', 'w', encoding='UTF8', newline='') as f:
    ...
    metaData_df= pd.read_csv('/home-mscluster/fmahlangu/2089676/atari_riverraid_data/meta_data.csv')

    dataframe= metaData_df[metaData_df.GameName=="riverraid"]
