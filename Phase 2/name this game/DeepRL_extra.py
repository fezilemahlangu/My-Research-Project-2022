...
def save_reward(fieldnames,rewards, model ):
  ...
  with open('/home-mscluster/fmahlangu/2089676/atari_name_this_game_data/results_phase2_extra.csv', 'a', encoding='UTF8') as f:
  ...
  with open('/home-mscluster/fmahlangu/2089676/atari_name_this_game_data/models_phase2_extra.csv', 'a', encoding='UTF8') as f:
      writer = csv.DictWriter(f, fieldnames=fieldnames)
      writer.writerows(rows)
...
def main():
  ...
  with open('/home-mscluster/fmahlangu/2089676/atari_name_this_game_data/results_phase2_extra.csv', 'w', encoding='UTF8', newline='') as f:
      writer = csv.DictWriter(f, fieldnames=fieldnames_results)
      writer.writeheader()

  fieldnames_results = ['models'] 
  with open('/home-mscluster/fmahlangu/2089676/atari_name_this_game_data/models_phase2_extra.csv', 'w', encoding='UTF8', newline='') as f:
      writer = csv.DictWriter(f, fieldnames=fieldnames_results)
      writer.writeheader()
  ...
  params.append([[16, 2, 1, 2, 0.05, 128, 0.05, 0.02],[32, 4, 2, 3, 0.15],[52, 5, 1, 2, 0.15]])
  params.append([[32, 3, 1, 2, 0.25, 128, 0.25, 0.00005],[64, 2, 2,  3, 0.15],[256, 5, 1, 2, 0.35]])
  params.append([[32, 4, 1, 2, 0.03, 64, 0.03, 0.004],[64, 3, 3, 2, 0.15],[512, 3, 1, 3, 0.05]])
