...
def save_reward(fieldnames,rewards, model ):
  ...
  with open('/home-mscluster/fmahlangu/2089676/atari_name_this_game_data/results_phase2.csv', 'a', encoding='UTF8') as f:
  ...
  with open('/home-mscluster/fmahlangu/2089676/atari_name_this_game_data/models_phase2.csv', 'a', encoding='UTF8') as f:
      writer = csv.DictWriter(f, fieldnames=fieldnames)
      writer.writerows(rows)
...
def main():
  ...
  with open('/home-mscluster/fmahlangu/2089676/atari_name_this_game_data/results_phase2.csv', 'w', encoding='UTF8', newline='') as f:
      writer = csv.DictWriter(f, fieldnames=fieldnames_results)
      writer.writeheader()

  fieldnames_results = ['models'] 
  with open('/home-mscluster/fmahlangu/2089676/atari_name_this_game_data/models_phase2.csv', 'w', encoding='UTF8', newline='') as f:
      writer = csv.DictWriter(f, fieldnames=fieldnames_results)
      writer.writeheader()
  ...
  params.append([[32, 3, 2, 2, 0.05, 512, 0.05, 0.0001],[128, 3, 2, 3, 0.25],[]])#24
  params.append([[16, 5, 2,  2, 0.05, 128, 0.05, 0.01],[32, 3, 1, 3, 0.25],[32, 3, 1, 3, 0.25]])#25
  params.append([[32, 8, 4, 1, 0.05, 256, 0.05, 0.1],[64, 4, 2, 1, 0.25],[128, 3, 1,  1, 0.25]])#29
  params.append([[16, 7, 4,  1, 0.05, 256, 0.05, 0.001],[32, 4, 2,  1, 0.25],[64, 3, 1, 1, 0.25]])#28
  params.append([[16, 8, 2, 2, 0.05, 128, 0.05, 0.01],[32, 3, 2,  3, 0.25],[64, 3, 1, 3, 0.25]])#26
  for p in params:
      first = p[0]
      second = p[1]
      third = p[2]
