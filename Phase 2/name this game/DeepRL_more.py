...
def save_reward(fieldnames,rewards, model ):
  ...
  with open('/home-mscluster/fmahlangu/2089676/atari_name_this_game_data/results_phase2_more.csv', 'a', encoding='UTF8') as f:
  ...
  with open('/home-mscluster/fmahlangu/2089676/atari_name_this_game_data/models_phase2_more.csv', 'a', encoding='UTF8') as f:
      writer = csv.DictWriter(f, fieldnames=fieldnames)
      writer.writerows(rows)
...
def main():
  ...
  with open('/home-mscluster/fmahlangu/2089676/atari_name_this_game_data/results_phase2_more.csv', 'w', encoding='UTF8', newline='') as f:
      writer = csv.DictWriter(f, fieldnames=fieldnames_results)
      writer.writeheader()

  fieldnames_results = ['models'] 
  with open('/home-mscluster/fmahlangu/2089676/atari_name_this_game_data/models_phase2_more.csv', 'w', encoding='UTF8', newline='') as f:
      writer = csv.DictWriter(f, fieldnames=fieldnames_results)
      writer.writeheader()

  #arguments 
  args = {
      "env_name" : "NameThisGameNoFrameskip-v4", #name of environment used #Enduro-v4
  ...
  #second run 
  params.append([[16, 1, 1, 'same', 'relu', 2, 0.05, 32, 0.05, 0.001],[],[]]) #2
  params.append([[16, 7, 1, 'same', 'relu', 2, 0.05, 128, 0.05, 0.02],[],[]]) #4
  params.append([[16, 8, 1, 'same', 'relu', 2, 0.05, 128, 0.1, 0.0001],[],[]]) #5
  
  params.append([[16, 3, 1, 'same', 'relu', 2, 0.05, 128, 0.25, 1e-05],[],[]]) #6
  params.append([[16, 5, 1, 'same', 'relu', 2, 0.15, 256, 0.05, 0.01],[],[]]) #9
  
  params.append([[32, 3, 1, 'same', 'relu', 2, 0.05, 256, 0.05, 0.001],[],[]]) #12
  params.append([[64, 8, 1, 'same', 'relu', 2, 0.05, 512, 0.05, 0.0001],[],[]]) #13
