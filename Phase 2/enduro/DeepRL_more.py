...
def save_reward(fieldnames,rewards, model ):
  ...
  with open('/home-mscluster/fmahlangu/2089676/atari_enduro_data/results_phase2_more.csv', 'a', encoding='UTF8') as f:
  ...
  with open('/home-mscluster/fmahlangu/2089676/atari_enduro_data/models_phase2_more.csv', 'a', encoding='UTF8') as f:
      writer = csv.DictWriter(f, fieldnames=fieldnames)
      writer.writerows(rows)
...
def main():
  ...
  with open('/home-mscluster/fmahlangu/2089676/atari_enduro_data/results_phase2_more.csv', 'w', encoding='UTF8', newline='') as f:
      writer = csv.DictWriter(f, fieldnames=fieldnames_results)
      writer.writeheader()

  fieldnames_results = ['models'] 
  with open('/home-mscluster/fmahlangu/2089676/atari_enduro_data/models_phase2_more.csv', 'w', encoding='UTF8', newline='') as f:
      writer = csv.DictWriter(f, fieldnames=fieldnames_results)
      writer.writeheader()
